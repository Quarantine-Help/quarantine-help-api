...
class EmailPusher(object):
    @classmethod
    def send_email_to_af_user_on_assignment_by_hl(
        cls, request=None, request_assignment=None
    ):
        context_data = {"request": request, "request_assignment": request_assignment}
        ...
        html_body_transformed = transform(html_body, exclude_pseudoclasses=False)
